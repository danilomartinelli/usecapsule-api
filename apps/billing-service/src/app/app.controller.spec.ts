...
describe('Billing Service - AppController', () => {
  ...
  describe('healthCheck', () => {
    ...
    it('should maintain response integrity across multiple calls', () => {
      ...
      expect(result1.service).toBe('billing-service');
      expect(result2.service).toBe('billing-service');
      expect(result3.service).toBe('billing-service');
    });
