...
describe('Deploy Service - AppController', () => {
  ...
  describe('healthCheck', () => {
    ...
    it('should handle healthy status', () => {
      ...
      expect(result.service).toBe('deploy-service');
    });
    ...
    it('should maintain response integrity across multiple calls', () => {
      ...
      expect(result1.service).toBe('deploy-service');
      expect(result2.service).toBe('deploy-service');
      expect(result3.service).toBe('deploy-service');
    });
