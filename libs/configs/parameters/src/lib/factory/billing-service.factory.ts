import type { BillingServiceConfig } from '../schemas/billing-service.schema';
 ...
 * ```
 */
export const billingServiceFactory = (): BillingServiceConfig => ({
  ...
  BILLING_DB_HOST: process.env.BILLING_SERVICE_DB_HOST || '',
  BILLING_DB_PORT: Number.parseInt(process.env.BILLING_SERVICE_DB_PORT || '5432', 10),
  BILLING_DB_NAME: process.env.BILLING_SERVICE_DB_NAME || '',
  BILLING_DB_USER: process.env.BILLING_SERVICE_DB_USER || '',
  BILLING_DB_PASSWORD: process.env.BILLING_SERVICE_DB_PASSWORD || '',
  BILLING_DB_SSL: process.env.BILLING_SERVICE_DB_SSL === 'true',
  STRIPE_SECRET_KEY: process.env.BILLING_SERVICE_STRIPE_SECRET_KEY || '',
  STRIPE_PUBLISHABLE_KEY: process.env.BILLING_SERVICE_STRIPE_PUBLISHABLE_KEY || '',
  STRIPE_WEBHOOK_SECRET: process.env.BILLING_SERVICE_STRIPE_WEBHOOK_SECRET || '',
  BILLING_CURRENCY: process.env.BILLING_SERVICE_CURRENCY || 'usd',
