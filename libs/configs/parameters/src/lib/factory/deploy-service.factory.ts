...
export const deployServiceFactory = (): DeployServiceConfig => ({
  ...
  DEPLOY_DB_HOST: process.env.DEPLOY_DB_HOST || '',
  DEPLOY_DB_PORT: Number.parseInt(process.env.DEPLOY_DB_PORT || '5432', 10),
  DEPLOY_DB_NAME: process.env.DEPLOY_DB_NAME || '',
  DEPLOY_DB_USER: process.env.DEPLOY_DB_USER || '',
